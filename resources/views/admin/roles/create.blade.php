                    ...
                    <div class="form-check mb-2 d-flex align-items-center justify-content-between">
                      <div class="d-flex align-items-center flex-grow-1">
                        <input class="form-check-input module-checkbox" type="checkbox" 
                               ...
                               {{ old('permissions') && in_array($moduleKey, old('permissions')) ? 'checked' : '' }}>
                      ...
                      <button type="button" class="btn btn-link text-white p-0 border-0 arrow-toggle-btn" 
                              ...
                              aria-expanded="{{ old('permissions') && in_array($moduleKey, old('permissions')) ? 'true' : 'false' }}"
                        ...
                        <i data-feather="chevron-down" class="arrow-icon" style="font-size: 14px; transition: transform 0.3s; width: 16px; height: 16px;"></i>
                      </button>
                      @endif
                    </div>
                    
                    @if(!empty($moduleData['sublinks']))
                    <div class="collapse ms-4 mt-2 {{ old('permissions') && in_array($moduleKey, old('permissions')) ? 'show' : '' }}" id="sublinks-{{ $moduleKey }}">
                      ...
                      <div class="form-check mb-2">
                        <input class="form-check-input sublink-checkbox" type="checkbox" 
                           ...
                           name="permissions[]"
                               ...
                               {{ old('permissions') && in_array($sublinkKey, old('permissions')) ? 'checked' : '' }}>
